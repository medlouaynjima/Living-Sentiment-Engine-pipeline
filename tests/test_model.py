...
class TestLabelMap:
    """Ensure LABEL_MAP in src.utils handles all FinBERT label variants."""
    ...
    def test_alias_labels(self):
        from src.utils import LABEL_MAP
        assert LABEL_MAP["label_0"] == "positive"
        assert LABEL_MAP["label_1"] == "negative"
        assert LABEL_MAP["label_2"] == "neutral"
